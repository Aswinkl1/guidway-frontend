...
export function LinkExpiredPage() {
  return (
    <div className="flex-1 flex items-center justify-center px-4">
      <div className="bg-white rounded-2xl w-full max-w-md px-10 py-10 flex flex-col items-center text-center gap-4 border-2 border-blue-400 border-dashed">
        {/* Icon */}
        ...
        {/* Back to log in */}
        <button className="text-sm text-gray-500 hover:text-gray-700 transition-colors mt-1">
          Back to log in
        </button>
      </div>
    </div>
