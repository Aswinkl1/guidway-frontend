...
const NAV_ITEMS = [
  ...
  },
  {
    ...
    icon: (
      <svg className="w-[18px] h-[18px]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeWidth="2" strokeLinecap="round" d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" />
      </svg>
    ),
  },
  {
...
export const Navbar = ()=>{
  return (<aside className="w-60 shrink-0 bg-white border-r border-gray-100 flex flex-col py-5 px-3">
        {/* Logo */}
