...
export const UsersTable = ({
  ...
  function handleConfirmAction(user: User | null | undefined) {
    if (!user) return;
    toggleBlock(user);
  }
  ...
  function handleBlock(user: User, action: "block" | "unblock") {
    setselectedItem({ user, action });
    setDialogOpen(true);
  }
  ...
  return (
    <>
      <BlockUserModal
        ...
        onConfirm={() => handleConfirmAction(selectedItem?.user)}
        open={dialogOpen}
        action={selectedItem?.action || "block"}
                  ...
                  >
                    ...
                    <td className="px-4 py-4">
                      <div className="flex items-center gap-2">
                        ...
                        {user.isBlocked ? (
                          <button
                            onClick={() => handleBlock(user, "unblock")}
                          ...
                          <button
                            onClick={() => handleBlock(user, "block")}
